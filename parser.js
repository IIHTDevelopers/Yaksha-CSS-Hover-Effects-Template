...
const htmlTagsTestCase = {
    ...
    extraParams: [['html', 'body', 'title', 'button']]
};
...
const requiredStyles = [
    {
        ...
        properties: [
            ...
            { key: 'border', value: '2px' },
            { key: 'padding', value: '10px 20px' },
...
const cssTestCase = {
    testCaseName: 'CSS button Styles Test',
    testCaseType: 'boundary',
...
const cssTestCase2 = {
    testCaseName: 'CSS button:hover Styles Test',
    testCaseType: 'boundary',
    testLogic: checkCssStyles,
